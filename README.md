...
Pet project по исследованию факторов, связанных с расходом топлива автомобилей. Проект объединяет разведочный анализ данных, статистические гипотезы, регрессионное моделирование и идентификацию распределений на Python.
